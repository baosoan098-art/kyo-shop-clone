...
const fallbackBanners: BannerItem[] = [
  {
    id: "fallback-1",
    title: "Cosmetics KYO Authentic",
    subtitle: "Ưu đãi quà tặng và mỹ phẩm chính hãng",
    ctaLabel: "Shop Now",
    href: "/shop",
...
const fallbackBannerImage =
  ...
  encodeURIComponent(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1600 700">
      ...
      <text x="800" y="290" font-size="78" text-anchor="middle" fill="#ef3f7d" font-family="Arial">KYO AUTHENTIC</text>
...
function normalizeBanner(record: BannerRecord, index: number): BannerItem | null {
  ...
  return {
    ...
    title: record.title ?? record.heading ?? "KYO Authentic",
    subtitle:
      record.subtitle ??
      record.description ??
